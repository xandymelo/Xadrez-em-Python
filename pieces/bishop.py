...
class Bishop(Piece):
    ...
    def mov_possiveis(self):#COMO FAZER NÃO REBATER A DIAGONAL NO MOVIMENTO? RESTO DA DIVISÃO DA POSIÇÃO POR 8, SUBTRAI O RESTO POR 8, É O NUMERO DE POSIÇÕES NAQUELA DIREÇÃO DA DIAGONAL#
        cor_do_jogador = ""
